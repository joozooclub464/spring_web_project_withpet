	...
	<div id="content">
		<form class="joinform__contatiner" action="join" method="post"
			...
			<div>
				...
				<input type="text" id="inputId" name="id" class="int" maxlength="20"> 
					<span class="step_url">@withpet.com</span>
				</span>
			</div>
			...
			<div>
				...
				<input type="password" id="inputPasswordCheck" class="int" maxlength="20">
				</span> 
				<span class="error_next_box"></span>
			</div>
			<!-- NAME -->
			<div>
				...
				<input type="text" id="inputName" name="name" class="int" maxlength="20">
				</span> 
				<span class="error_next_box"></span>
			</div>
			...
			<div>
				...
				<div id="bir_wrap">
					<!-- BIRTH_YY -->
					<div id="bir_yy">
						<span class="box"> <input type="text" id="yy" name="yy" class="int" maxlength="4" placeholder="년(0000)">
						</span>
					</div>
					...
					<div id="bir_dd">
						<span class="box"> 
						<input type="text" id="dd" name="dd" class="int" maxlength="2" placeholder="일(00)">
						</span>
					</div>
			...
			<div>
				...
				<input type="text" id="mobile" name="tel" class="int" maxlength="16" placeholder="전화번호 입력">
				</span> 
				<span class="error_next_box"></span>
			</div>
			...
			<div>
				...
				<span class="box int_mobile"> 
				<input type="text" id="inputAddress" name="address" class="int" maxlength="200" placeholder="주소 입력">
				</span> 
				<span class="error_next_box"></span>
			</div>
			...
			<div>
				...
				<span class="box int_mobile"> 
				<input type="text" id="inputPet_kind" name="pet_kind" class="int" maxlength="16" placeholder="반려동물 종류 입력">
				</span> 
				<span class="error_next_box"></span>
			</div>
			...
			<div>
				...
				<span class="box int_mobile"> 
				<input type="text" id="inputPet_name" name="pet_name" class="int" maxlength="16" placeholder="반려동물 이름 입력">
				</span> 
				<span class="error_next_box"></span>
			</div>
			...
			<div>
				...
				<span class="box int_mobile"> 
				<input type="text" id="inputPet_age" name="pet_age" class="int" maxlength="16" placeholder="반려동물 나이 입력">
				</span> 
				<span class="error_next_box"></span>
			</div>
			...
			<div class="hotel_div form-check">
				<br /> 
				<input type="checkbox" class="form-check-input" id="check_all" value="1" name="agree"> 
			...
			<ul class='select_subject'>
				<div class="hotel_div p-3 border">
					...
					<div class="check__clause">
						<input type="checkbox" class="normal" id="privacyCheck" name="agree"> 
						<label class="form-check-label" for="privacyCheck">개인정보수집 및 이용에 대한 안내 </label>
					</div>

					<div class="check__clause">
						<input type="checkbox" class="normal" id="agree" value="1" name="agree"> 
